...
const SHOPIFY_STORE_PERMANENT_DOMAIN = 'street-style-direct-bib60.myshopify.com';
export const SHOPIFY_STOREFRONT_URL = `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/api/${SHOPIFY_API_VERSION}/graphql.json`;
export const SHOPIFY_STOREFRONT_TOKEN = '1b1b2ccefd257cb251f32d445897c279';
...
export async function fetchProducts(limit: number = 50, query?: string): Promise<ShopifyProduct[]> {
  ...
  }>(PRODUCTS_QUERY, { first: limit, query: query || null });
